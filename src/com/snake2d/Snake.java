package com.snake2d;
/*Class Snake akan berisi fungsi untuk menambah panjang ular, memeriksa apakah ular
menabrak dinding, ke arah mana ular bergerak dan memeriksa apakah ular bertemu
dengan pemburu atau tidak serta dapat melakukan teleportasi dengan posisi yang random.*/
...
public class Snake {
	...
	public void teleport(){
		...
		do {
			xHead = (int) (rand.nextInt(30));
		yHead = (int) (rand.nextInt(39));
		}
		while(xHead == 0 || yHead == 0 || xHead == 38 || yHead == 29);
		...
		Ellipse2D.Double temp = (Ellipse2D.Double) snakeBody.get(0);
		Ellipse2D.Double elli = new Ellipse2D.Double(xHead, yHead,
				temp.getWidth(), temp.getHeight());
